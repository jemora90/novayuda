...
<form name="form1" action="home.php?pac=<?php echo $pac; ?>" method="post" >
	<table width="400">
    	...
    	<tr>
        	...
        	<td><input type="text" name="nombre_parametro" size="30" maxlength="30" required="required" /></td>
        </tr>  
        <tr>
        	<td colspan="2" align="center">
...
<form id="form2" name="form2" method="GET" action="home.php?pac=<?php echo $pac; ?>" onSubmit="return confirm('¿Eliminara El Parametro y sus Valores asociados desea continuar?')">
  ...
  <div align="center" class="zebra">
    ...
    <td class="style2" align="center">
     <?php if ($datos[$i]['codigo_parametro']<=7){ 
     	echo $datos[$i]['codigo_parametro'];
	 }else{ ?>           
		<input type="submit" name="del" value=<?php echo $datos[$i]['codigo_parametro']?>>
        <?php } ?>
        </td>
            <td class="style2" align="left"><?php echo $datos[$i]['nombre_parametro'] ?></td>
            <td align="center"><a href="home.php?pr=<?php echo $datos[$i]['codigo_parametro'] ?>&pac=102&up=11&ed=0"><img border=0 src="image/editar.png" width="16" height="16" /></a></td>    
		</tr>
...
<form name="form3" action="" method="post" >
	<table width="400">
    	...
    	<tr>
        	...
        	<td><input type="text" name="nombre_valor" size="30" maxlength="30" required="required" /></td>
        	<td align="left">Parametro</td>
        	<td>
               <select name="codigo_parametro">
	...
	<?php 
 	//Select
	  ...
	  ?>
            ...
            <option value="<?php echo $dat1[$i]['codigo_parametro'] ?>" ><?php echo $dat1[$i]['nombre_parametro'] ?></option>
...
<div>
    	...
    	<table width="550" border="" cellspacing="0" cellpadding="4">
	...
	?>	
    <tr>           
		<td class="style2" align="center"><input type="submit" name="del2" value=<?php echo $dat2[$i]['codigo_valor']?>>
        </td>
            <td class="style2" align="left"><?php echo $datos[$i]['nombre_valor'] ?></td>
            <td class="style2" align="left"><?php echo $datos[$i]['nombre_parametro'] ?></td>
            <td align="center"><a href="home.php?pr=<?php echo $datos[$i]['codigo_valor'] ?>&pac=102&up=11&ed=1&prr=<?php echo $dat2[$i]['codigo_parametro'] ?>"><img border=0 src="image/editar.png" width="16" height="16" /></a></td>    
		</tr>
