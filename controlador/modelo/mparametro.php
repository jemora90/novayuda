...
class mparametro{
	...
	function selpar1($codpar){
		...
		$sql = "SELECT parametro.nompar ,valor.codval, valor.nomval  FROM parametro LEFT JOIN valor ON parametro.codpar=valor.codpar";
		if($filtro)
			$sql.= " WHERE valor.nomval LIKE '%".$filtro."%'";
